class Api::V1::Advisor::ClientsController < ApplicationController
  ...
  def destroy
    client = Client.find(params[:id])
    # Cambiamos estado en lugar de destruir para no romper llaves foráneas, 
    # o si quieres eliminarlo físicamente usas destroy!
