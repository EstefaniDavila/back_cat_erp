  ...
  module V1
    module Admin
      class PurchaseOrderItemsController < ApplicationController
        ...
        # PUT /api/v1/admin/purchase_order_items/:id
        def update
        ...
        # DELETE /api/v1/admin/purchase_order_items/:id
        def destroy
        ...
        # POST /api/v1/admin/purchase_orders/:purchase_order_id/items/bulk_create
        def bulk_create
